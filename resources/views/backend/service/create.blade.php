                    ...
                    <form method="post" action="{{route('service.store')}}">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('title')}}" type="text" class="form-control form-control-sm form-control-dark" name="title" placeholder="Enter the service title....">
                                @error('title')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('icon')}}" type="text" class="form-control form-control-sm form-control-dark" name="icons" placeholder="fab fa-facebook">
                                @error('icon')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><textarea name="description" id="textarea-input" rows="9"
                                                                   placeholder="Enter service description..." class="form-control form-control-sm" style="resize: none">{{old('description')}}</textarea>
                                @error('description')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
