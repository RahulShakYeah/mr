                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Slider photo</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <form method="post" action="{{route('slider.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('primary_text')}}" type="text" class="form-control form-control-sm form-control-dark" name="primary_text" placeholder="Enter the primary text....">
                                @error('primary_text')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('secondary_text')}}" type="text" class="form-control form-control-sm form-control-dark" name="secondary_text" placeholder="Enter the secondary text....">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('priority')}}" type="number" class="form-control form-control-sm form-control-dark" name="priority" placeholder="Enter the priority">
                                @error('icon')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
