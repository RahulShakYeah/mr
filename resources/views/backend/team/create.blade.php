    ...
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Add Team Member Details</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        ...
        <div class="card">
            <div class="card-header" style="border-bottom: 1px solid #3c8dbc">
                <h3 class="card-title" >Add team member details</h3>
            </div>
            <div class="card-body">
                    ...
                    <form method="post" action="{{route('team.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('name')}}" type="text" class="form-control form-control-sm form-control-dark" name="name" placeholder="Enter the team member name....">
                                @error('name')
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('position')}}" type="text" class="form-control form-control-sm form-control-dark" name="position" placeholder="Enter the team member position....">
                                @error('position')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('email')}}" type="email" class="form-control form-control-sm form-control-dark" name="email" placeholder="Enter the team member email....">
                                @error('email')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('linkedin')}}" type="email" class="form-control form-control-sm form-control-dark" name="linkedin" placeholder="Enter the team member linkedin....">
                                @error('linkedin')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input value="{{old('phone')}}" type="number" class="form-control form-control-sm form-control-dark" name="phone" placeholder="Enter the team member phone number....">
                                @error('phone')
                                <span class="alert-danger col-12 col-md-9">{{$message}}</span>
                                @enderror
                            </div>
